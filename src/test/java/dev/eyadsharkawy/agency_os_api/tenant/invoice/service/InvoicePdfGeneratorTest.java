...
class InvoicePdfGeneratorTest {
    ...
    void generate_SingleProject_Success() throws IOException {
        ...
        byte[] pdf = InvoicePdfGenerator.generate(invoice, "Acme Agency", "contact@acme.com", List.of(entry));
    ...
    void generate_MultipleProjects_Success() throws IOException {
        ...
        byte[] pdf = InvoicePdfGenerator.generate(invoice, "Acme Agency", "contact@acme.com", List.of(entry1, entry2));
    ...
    void generate_EmptyBilledEntries_Fallback() throws IOException {
        byte[] pdf = InvoicePdfGenerator.generate(invoice, "Acme Agency", "contact@acme.com", List.of());
