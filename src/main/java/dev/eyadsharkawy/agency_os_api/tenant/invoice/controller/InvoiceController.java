...
public class InvoiceController {
  ...
  @Operation(
      ...
      description =
          "Consolidates all unbilled time entries for a client and auto-generates a billing invoice. Restricted strictly to the OWNER.")
  ...
  @Operation(
      ...
      description =
          "Retrieves all invoices. CLIENT portal contacts only see invoices associated with their company. MEMBERS are completely blocked. Restricted to OWNER, ADMIN, or CLIENT.")
  ...
  @Operation(
      ...
      description =
          "Retrieves metadata of a specific invoice. CLIENT portal contacts can only look up their own company invoices. Restricted to OWNER, ADMIN, or CLIENT.")
  ...
  @Operation(
      ...
      description =
          "Lists all invoices generated for a specific client company. Restricted to OWNER or ADMIN.")
  ...
  @Operation(
      ...
      description = "Modifies an invoice's status or details. Restricted strictly to the OWNER.")
  ...
  @Operation(
      ...
      description =
          "Permanently deletes an invoice and returns all billed time entries back to 'unbilled' status. Restricted strictly to the OWNER.")
  ...
  @Operation(
      ...
      description =
          "Renders and outputs a print-ready multi-page PDF document containing breakdown metrics, logo, and payment instructions. CLIENT users can only download their own invoice PDFs.")
  public ResponseEntity<byte[]> downloadInvoicePdf(
    ...
    headers.setContentDisposition(
        ContentDisposition.builder("inline").filename("invoice-" + id + ".pdf").build());
