...
@Schema(name = "07.1. InvoiceRequest", description = "Request payload for creating or updating an invoice")
public record InvoiceRequest(
        @Schema(description = "ID of the client for whom the invoice is created", example = "123e4567-e89b-12d3-a456-426614174000")
