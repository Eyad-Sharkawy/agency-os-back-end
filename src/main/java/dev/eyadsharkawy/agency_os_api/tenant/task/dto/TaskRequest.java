...
public record TaskRequest(
        ...
        @Schema(description = "Task due timestamp", example = "2026-02-15T18:00:00Z")
        Instant dueDate,
        ...
        @Schema(description = "ID of the project this task belongs to", example = "123e4567-e89b-12d3-a456-426614174000")
