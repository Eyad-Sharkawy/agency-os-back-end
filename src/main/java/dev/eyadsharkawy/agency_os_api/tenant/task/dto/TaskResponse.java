...
public record TaskResponse(
        ...
        @Schema(description = "Detailed description of the task", example = "Create high-fidelity wireframes for desktop and mobile layouts")
        String description,
        ...
        @Schema(description = "ID of the associated project", example = "123e4567-e89b-12d3-a456-426614174000")
        UUID projectId,

        @Schema(description = "Set of user IDs assigned to this task", example = "[\"user-123\", \"user-456\"]")
        ...
        @Schema(description = "Timestamp when the task was last updated", example = "2026-01-02T12:00:00Z")
        Instant updatedAt
) {
