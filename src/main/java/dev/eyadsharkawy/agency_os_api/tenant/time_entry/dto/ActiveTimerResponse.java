...
@Schema(
    name = "06.3. ActiveTimerResponse",
    description = "Response details of an active running timer")
public record ActiveTimerResponse(
    @Schema(description = "ID of the user running the timer", example = "user-123") String userId,
    @Schema(
            description = "ID of the task currently being timed",
