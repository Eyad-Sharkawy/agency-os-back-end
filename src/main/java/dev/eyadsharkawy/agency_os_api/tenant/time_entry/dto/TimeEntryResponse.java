...
public record TimeEntryResponse(
        @Schema(description = "Unique identifier of the time entry", example = "123e4567-e89b-12d3-a456-426614174000")
        UUID id,
        ...
        @Schema(description = "Timestamp when the time entry was logged", example = "2026-01-01T10:00:00Z")
        Instant createdAt,

        @Schema(description = "Timestamp when the time entry was last updated", example = "2026-01-02T12:00:00Z")
        Instant updatedAt
) {
