...
public class ProjectController {
  ...
  @Operation(
      ...
      description =
          "Retrieves all projects. CLIENT users only see projects belonging to their company; MEMBER users only see projects where they hold at least one assigned task.")
  ...
  @Operation(
      ...
      description =
          "Retrieves detailed information of a project. Verifies that CLIENT users belong to the linked company, and MEMBER users hold assigned tasks.")
  ...
  @Operation(
      ...
      description =
          "Lists all projects associated with a specific client company. Restricted to OWNER, ADMIN, or MEMBER.")
  ...
  @Operation(
      ...
      description =
          "Modifies project parameters. Only the OWNER is allowed to change or assign client mappings; Admins are blocked. Restricted to OWNER or ADMIN.")
  ...
  @Operation(
      ...
      description =
          "Permanently deletes a project from the system. Restricted strictly to the OWNER.")
