...
@Tag(name = "02. Workspace Invitations", description = "Endpoints for sending, listing, accepting, and declining invitations to join workspaces")
public class WorkspaceInvitationController {
    ...
    @Operation(summary = "Send workspace invitation", description = "Allows workspace Owners and Admins to invite a teammate to join a workspace using their username or email. Only Owners can invite non-Member roles (e.g. Clients).")
    ...
    @Operation(summary = "List pending invitations", description = "Retrieves all pending workspace invitations sent to the authenticated user's email or username.")
    ...
    @Operation(summary = "Accept workspace invitation", description = "Accepts a pending invitation and automatically adds the user to the workspace. If the invitation is for a CLIENT role, they are also associated with the client company inside the tenant schema.")
    ...
    @Operation(summary = "Decline workspace invitation", description = "Declines a pending workspace invitation, changing its status to DECLINED.")
