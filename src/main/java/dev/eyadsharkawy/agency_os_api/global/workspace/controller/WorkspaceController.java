...
public class WorkspaceController {
  ...
  @Operation(
      ...
      description =
          "Initializes a new workspace tenant organization. The requesting user is automatically assigned the OWNER role.")
  public ResponseEntity<WorkspaceResponse> createWorkspace(
      @AuthenticationPrincipal Jwt jwt, @Valid @RequestBody WorkspaceRequest request) {
  ...
  @Operation(
      ...
      description =
          "Retrieves all workspace organizations associated with the currently authenticated user.")
  ...
  @Operation(
      ...
      description =
          "Updates metadata (e.g. name or contact email) of the specified workspace. Restricted strictly to the OWNER.")
  ...
  @Operation(
      ...
      description =
          "Performs a soft delete on a workspace tenant organization. Restricted strictly to the OWNER.")
  ...
  @Operation(
      ...
      description =
          "Retrieves the complete list of users registered in this workspace, alongside their active roles. Restricted to OWNER or ADMIN.")
  ...
  @Operation(
      ...
      description =
          "Changes the role (ADMIN, MEMBER, CLIENT) of a team member. Admins are blocked from promoting other admins or modifying other admins/clients. Restricted to OWNER or ADMIN.")
  ...
  @Operation(
      ...
      description =
          "Removes a user from this workspace. Admins are blocked from removing other admins or clients. Restricted to OWNER or ADMIN.")
  ...
  @Operation(
      ...
      description =
          "Transfers the OWNER status to a target member, demoting the current caller to ADMIN. Restricted strictly to the OWNER.")
