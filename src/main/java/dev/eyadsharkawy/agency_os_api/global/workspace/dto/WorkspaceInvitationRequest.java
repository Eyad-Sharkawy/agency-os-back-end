...
@Schema(
    name = "02.1. WorkspaceInvitationRequest",
    description = "Request payload to send an invitation to join a workspace")
public record WorkspaceInvitationRequest(
    ...
    @Schema(description = "Workspace role to be assigned upon joining", example = "MEMBER")
        ...
        WorkspaceRole role,
    @Schema(
            description = "Optional client ID to restrict access if role is CLIENT",
