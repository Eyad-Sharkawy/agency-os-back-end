...
@Schema(
    name = "01.3. WorkspaceMemberResponse",
    description = "Details of a member within a workspace")
public record WorkspaceMemberResponse(
    ...
    @Schema(description = "Last name of the member", example = "Doe") String lastName,
    @Schema(description = "Role of the member in the workspace", example = "ADMIN") String role) {
