...
@Schema(
    name = "01.4. WorkspaceMemberUpdateRequest",
    description = "Request payload for updating a workspace member's role or assigned client")
public record WorkspaceMemberUpdateRequest(
    @Schema(description = "New workspace role to assign to the member", example = "MEMBER")
        ...
        WorkspaceRole role,
    @Schema(
            description = "Optional client ID if restricted to a specific client",
