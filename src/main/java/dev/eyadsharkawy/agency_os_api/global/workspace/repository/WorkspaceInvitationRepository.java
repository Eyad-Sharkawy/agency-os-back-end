...
public interface WorkspaceInvitationRepository extends JpaRepository<WorkspaceInvitation, UUID> {
    List<WorkspaceInvitation> findByUsernameIgnoreCaseAndStatus(String username, InvitationStatus status);

    Optional<WorkspaceInvitation> findByWorkspaceIdAndUsernameIgnoreCase(UUID workspaceId, String username);
}
