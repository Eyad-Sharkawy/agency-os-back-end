...
public record WorkspaceResponse(
    @Schema(
        ...
        UUID id,
    @Schema(description = "Name of the workspace", example = "Acme Agency") String name,
    @Schema(
            description = "Tenant identifier associated with the workspace",
            example = "tenant-acme")
        String tenantId,
    @Schema(description = "Contact email of the workspace owner/admin", example = "admin@acme.com")
        String contactEmail,
    @Schema(description = "User's role in the workspace", example = "OWNER") String role,
    @Schema(description = "Whether the workspace is active", example = "true") boolean isActive,
    @Schema(
